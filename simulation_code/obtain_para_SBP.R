...
library(data.table)
library(plink2R)
out_name = 'SBP_rs16849273'
  plink_command = paste0("module load plink; \n","plink --bfile /home/panwei/lin00374/metabolites/redo/SBP/110K_QCed",
                        " --extract rs16849273 ",
                        " --make-bed --out ",
                        out_name,sep="")
  ...
  snp = tryCatch(read_plink(paste(out_name,sep="")),
                 error=function(e){cat("ERROR :",
                                       conditionMessage(e),
                                       "\n")})
met = fread('/home/panwei/lin00374/metabolites/redo/SBP/MET_20PC_PRScs.txt')
y = fread('/home/panwei/lin00374/metabolites/redo/SBP/ukb_int.txt')
...
save.image(file='SBP_rs16849273.RData')
